...
-- Default tab width and indent size
vim.opt.tabstop = 2
...
-- Keymap for clearing last search
vim.keymap.set('n', 'C', ':let @/=""<Enter>', { desc = 'Clear last search' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>gc', lga_shortcuts.grep_word_under_cursor, { desc = '[G]rep [C]urrent word(under a cursor)' })
